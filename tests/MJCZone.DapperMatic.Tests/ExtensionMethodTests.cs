...
public class ExtensionMethodTests
{
    ...
    [InlineData(typeof(IEnumerable<IDictionary<string, List<int>>>), "IEnumerable<IDictionary<String, List<Int32>>>")]
    ...
    public void Should_test_to_alpha(string input, string expected, string additionalAllowedCharacters = "")
    {
    ...
    public void Should_test_discard_length_precision_and_scale_from_sql_type_name(string input, string expected)
    {
